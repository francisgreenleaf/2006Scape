...
DEFAULT_ROUTE_EXECUTOR_EVIDENCE_JSONL = "agent-navigation/.local/run-evidence/ml2-route-executor.routes.jsonl"
...
def route_definition(args: SimpleNamespace, candidate: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "feedback": {
            ...
            "automaticEvents": ["route_batch", "route_transition", "route_outcome"] if actionable else [],
...
def rank_routes(args: SimpleNamespace) -> Dict[str, Any]:
    ...
    if getattr(args, "planner", "fast") == "fast":
        ...
        return {
            ...
            "candidates": [],
            "agentUsage": {
                "summary": "ML2 dev output: use recommended.routeDefinition.execution.command in controlled testing only; routeSteps may mix walk and object_transition steps.",
    ...
    return {
        ...
        "agentUsage": {
            "summary": "ML2 route output: routeSteps may mix walk and object_transition steps; active agents should use this service for new A-to-B route requests.",
