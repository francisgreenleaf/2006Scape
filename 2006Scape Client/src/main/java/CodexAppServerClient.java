...
public class CodexAppServerClient {
    ...
    private JsonArray dynamicTools() {
        ...
        tools.add(tool("click_interface_button_XXS", "Click a game interface/action button and return only confirmation plus critical player state.", schema("buttonId", "number", "actionButtonId", "number", "id", "number")));
