...
public class CodexAppServerClient {
    ...
    private JsonArray dynamicTools() {
        ...
        tools.add(tool("withdraw_bank_items_XXS", "Withdraw matching bank items and return confirmation plus critical player state.", schema("name", "string", "itemId", "number", "itemIds", "array", "amount", "number")));
        tools.add(tool("withdraw_bank_items_XS", "Compact bank withdrawal. Same behavior as withdraw_bank_items, but returns withdrawn counts plus compact inventory/bank context.", schema("name", "string", "itemId", "number", "itemIds", "array", "amount", "number")));
