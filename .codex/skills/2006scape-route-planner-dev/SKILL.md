...
description: "Use when designing, editing, debugging, or validating the 2006Scape route-planning system in /Users/kevin/Documents/2006Scape, including ML2 route_ml_XS.py define, legacy ML1/router.py/route_runner.py graph semantics, navdb.py, passive movement traces, server clipped-path previews, hazard/failure weighting, reverse-edge inference, coordinate targets, future ML/GNN routing datasets, evaluation metrics, and low-token A-to-B planning."
---
